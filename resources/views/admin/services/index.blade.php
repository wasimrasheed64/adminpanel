                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#add_new_social">Add Service
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a  class="btn btn-sm text-white px-5 mr-2 badge badge-primary"
                                                ...
                                                data-bs-target="#updatemainCategory{{ $service->id }}">Edit</a>
                                            <span class="menu-link btn btn-sm text-white ml-2 px-3 badge badge-danger"
                                                  onclick='deleteData("{{ $service->id }}", "{{ route('service.delete', $service->id) }}")'>Delete</span>
                                        </td>

                                        <!--begin::Modal - Create App-->
                                        <div class="modal fade" id="updatemainCategory{{ $service->id }}" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
...
{{--                                                                    ])--}}
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <input type="text" class="form-control form-control-solid"
                                                                       name="description" placeholder="Example input" id="categoryName"
...
{{--                            </div>--}}
                            ...
                            <div class="mb-10">
                                <label for="categoryName" class="required form-label">Icon Class</label>
                                <input type="text" class="form-control form-control-solid"
                                       name="description" placeholder="Example input" id="categoryName"
                                       required/>
                            </div>
