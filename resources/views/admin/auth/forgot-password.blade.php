<x-guest-layout>
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" method="post" action="{{ route('admin.password.email') }}">
                            <!--begin::Heading-->
    ...
    <x-slot name="script">
        ...
        <script src="{{URL::to('assets/js/custom/authentication/password-reset/password-reset.js')}}"></script>
