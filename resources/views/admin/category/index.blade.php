                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    <!--begin::Add Category-->
                                    <a href="{{ route('category.create') }}"><button type="button" class="btn btn-primary">Add New Category
                                    </button></a>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                                ...
                                                <span class="menu-link btn btn-sm text-white ml-2 px-3 badge badge-danger"
                                                      onclick='deleteData("{{ $category->id }}", "{{ route('category.delete', $category->id) }}")'>Delete</span>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
