                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#add_new_social">Add Promotion
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                @foreach($promotions  as $promotion)
                                    <tr>
                                        ...
                                        <td><img src="{{ $promotion->image }}" height="50px" alt="promotion image"></td>
                                        <td>{{ $promotion->created_at->format('M d,Y') }}</td>
                                        <td>
                                            <a  class="btn btn-sm text-white px-5 mr-2 badge badge-primary"
                                                data-bs-toggle="modal"
                                                data-bs-target="#updatemainCategory{{ $promotion->id }}">Edit</a>
                                            <span class="menu-link btn btn-sm text-white ml-2 px-3 badge badge-danger"
                                                  onclick='deleteData("{{ $promotion->id }}", "{{ route('promotion.delete', $promotion->id) }}")'>Delete</span>
                                        </td>

                                        <!--begin::Modal - Create App-->
                                        <div class="modal fade" id="updatemainCategory{{ $promotion->id }}" tabindex="-1" aria-hidden="true">
                                            <!--begin::Modal dialog-->
                                                    ...
                                                    <div class="modal-body py-lg-10 px-lg-10">
                                                        <form method="post" action="{{ route('promotion.update',$promotion->id) }}"
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <input type="text" class="form-control form-control-solid"
                                                                       name="link" placeholder="Example input" id="categoryName"
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <select name="class" class="form-control form-control-solid">
                                                                    ...
                                                                    <option
                                                                        {{ $promotion->class == 3 ? 'selected' : ""   }}
                                                                        value="3">Col-3</option>
                                                                    <option
                                                                        {{ $promotion->class == 4 ? 'selected' : ""   }}
                                                                        value="4">Col-4</option>
                                                                    <option
                                                                        {{ $promotion->class == 5 ? 'selected' : ""   }}
                                                                        value="5">Col-5</option>
                                                                    <option
                                                                        {{ $promotion->class == 6 ? 'selected' : ""   }}
                                                                        value="6">Col-6</option>
                                                                    <option
                                                                        {{ $promotion->class == 7 ? 'selected' : ""   }}
                                                                        value="7">Col-7</option>

                                                                    <option
                                                                        {{ $promotion->class == 8 ? 'selected' : ""   }}
                                                                        value="8">Col-8</option>
                                                                    <option
                                                                        {{ $promotion->class == 9 ? 'selected' : ""   }}
                                                                        value="9">Col-9</option>
                                                                    <option
                                                                        {{ $promotion->class == 10 ? 'selected' : ""   }}
                                                                        value="10">Col-10</option>
                                                                    <option
                                                                        {{ $promotion->class == 12 ? 'selected' : ""   }}
                                                                        value="12">Col-12</option>
                    ...
                    <div class="modal-body py-lg-10 px-lg-10">
                        <form method="post" action="{{ route('promotion.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-10">
                                ...
                                <select name="page" id="" class="form-control form-control-solid">
                                    <option value="1">Home page</option>
                                    <option value="2">Category Page</option>
                                    <option value="3">Product Page</option>
                                </select>
                            </div>
