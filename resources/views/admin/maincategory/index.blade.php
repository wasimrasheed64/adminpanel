                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#add_new_category">Add Main Category
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                @foreach($mainCategories  as $mainCategory)
                                    <tr>
                                        ...
                                        <td>{{ $mainCategory->created_at->format('M d,Y') }}</td>
                                        <td>
                                            <a class="btn btn-sm text-white px-5 mr-2 badge badge-primary"
                                               data-bs-toggle="modal"
                                               data-bs-target="#updatemainCategory{{ $mainCategory->id }}">Edit</a>
                                            <span class="menu-link btn btn-sm text-white ml-2 px-3 badge badge-danger"
                                                  onclick='deleteData("{{ $mainCategory->id }}", "{{ route('maincategory.delete', $mainCategory->id) }}")'>Delete</span>
                                        </td>

                                        <!--begin::Modal - Create App-->
                                        <div class="modal fade" id="updatemainCategory{{ $mainCategory->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-900px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <!--begin::Modal title-->
                                                        <h2>Update New Main Category</h2>
                                                        <!--end::Modal title-->
                                                        <!--begin::Close-->
									...
									<rect x="7.41422" y="6" width="16" height="2" rx="1"
                                          transform="rotate(45 7.41422 6)" fill="black"/>
                                                    ...
                                                    <div class="modal-body py-lg-10 px-lg-10">
                                                        <form method="post"
                                                              action="{{ route('maincategory.update',$mainCategory->id) }}"
                                                        enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-10">
                                                                @include('partials.forms.imageInput',[
                                                                             ...
                                                                             "label" => "Image",
                                                                             "class" => "col-md-12",
                                                                             "value" => $mainCategory->image

                                                                        ])


                                                                <label for="categoryName" class="required form-label">Main
                                                                    Category Name</label>
                                                                <input type="text"
        ...
        <div class="modal fade" id="add_new_category" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-900px">
                ...
                <div class="modal-content">
                    ...
                    <!--begin::Modal body-->
                    <div class="modal-body py-lg-10 px-lg-10">
                        <form method="post" action="{{ route('maincategory.store') }}"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="mb-10">
                                @include('partials.forms.imageInput',[
